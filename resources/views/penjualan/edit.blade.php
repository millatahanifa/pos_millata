...
@section('title', 'Edit Penjualan - Bubu Bakery')
...
<div class="top-header d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4 pb-3 border-bottom">
    <div>
        <h1 class="page-title fw-bold mb-1" style="color: var(--primary-dark, #3a1a05); font-size: 1.65rem;">Edit Penjualan</h1>
        <div class="date-subtitle text-muted fs-6">
            <i class="bi bi-pencil-square me-1"></i> Perbarui transaksi penjualan dan keranjang belanja
        </div>
    </div>
    <div>
