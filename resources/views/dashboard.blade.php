...
<div class="container-fluid px-0">
    <div class="top-header d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3 mb-4 pb-3 border-bottom">
        <div>
            <h2 class="page-title fw-bold mb-1" style="color: var(--primary-dark); font-size: 1.45rem;">Ringkasan Hari Ini</h2>
            <div class="date-subtitle text-muted small">
                    ...
                    <table class="table align-middle text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="fw-semibold text-wrap">{{ $produk->nama }}</td>
                                <td class="text-end">
    ...
    <div class="row g-3 mb-4">
        <div class="col-12">
            <div class="custom-table-card bg-white border rounded-4 p-3 p-md-4 shadow-sm">
                <div class="table-responsive">
                    <table class="table align-middle text-nowrap">
                        <thead class="table-light">
                            <tr>
